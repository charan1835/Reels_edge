      ...
      <div className="w-full px-4 py-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-center items-center h-48 md:h-64">
            <div className="text-slate-400 text-sm md:text-base">Loading categories...</div>
          </div>
        </div>
      </div>
    )
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8 px-2 gap-4 sm:gap-0">
          <div className="flex items-center gap-2 sm:gap-4">
            <h2 className="text-xl sm:text-2xl font-mono text-white tracking-wider">Categories</h2>

            {/* Mobile Touch Indicator */}
            {isMobile && (
              <div className="flex items-center gap-1 px-2 py-1 rounded-full bg-blue-600/20 text-blue-400 border border-blue-500/30">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="p-2 rounded-full bg-slate-700/80 hover:bg-slate-600 text-white transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        {isMobile && (
          <div className="text-center mb-4">
            <p className="text-xs text-slate-500 font-mono">👆 Swipe left or right • Tap to select</p>
          </div>
        )}
                  ...
                  <div className="relative group">
                    <div
                      className={`
                        ...
                        ${isCenter ? "shadow-xl shadow-blue-900/20" : "shadow-lg"}
          ...
          {isTouching && (
            <>
              <div
                ...
                `}
              >
                <ChevronLeft className="w-6 h-6 sm:w-8 sm:h-8 text-blue-400" />
              </div>
              <div
                className={`
        ...
        <div className="mt-6 sm:mt-8">
          ...
          <div
            ...
            className="flex gap-2 sm:gap-4 overflow-x-auto scrollbar-thin scrollbar-track-slate-800 scrollbar-thumb-slate-600 hover:scrollbar-thumb-slate-500 pb-4"
          ...
          {categories.map((_, index) => (
            <button
              ...
              className={`
                ...
                ${index === currentIndex ? "bg-blue-500 w-6 sm:w-8" : "bg-slate-600 hover:bg-slate-500 w-2"}
