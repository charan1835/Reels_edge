  ...
  return (
    <div className="w-full">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className={`grid ${getGridClasses()} gap-4 px-4`}
      >
        <AnimatePresence>
          {edits.map((edit, index) => {
            ...
            return (
              <motion.div
                ...
                variants={item}
                layout
                className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 group relative border border-slate-200 dark:border-gray-800"
              >
